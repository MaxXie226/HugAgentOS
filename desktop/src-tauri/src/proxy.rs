...
const MAC_OFFSET_SPA: &str =
    ":root{--hugagent-desktop-titlebar-height:28px;--hugagent-desktop-sidebar-width:100%}body{box-sizing:border-box!important;padding-top:28px!important;background:var(--color-bg-layout)!important}:root[data-mac-immersive] body{padding-top:0!important}.jx-brandRow{padding-top:38px!important}.jx-miniRail{padding-top:38px!important;width:88px}.jx-sider.ant-layout-sider-collapsed{width:88px!important;min-width:88px!important;max-width:88px!important}.jx-appLoading{height:100%!important}.jx-appLoading-sidebar{box-sizing:border-box;padding-top:38px!important}.ant-message{top:calc(var(--hugagent-desktop-titlebar-height) + 8px)!important}.ant-notification-top,.ant-notification-topLeft,.ant-notification-topRight{top:calc(var(--hugagent-desktop-titlebar-height) + 24px)!important}";
